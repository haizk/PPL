                    ...
                    <form class="form-body row g-3" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="d-grid gap-2">
                                <a href="{{ route('auth.google') }}" class="btn border border-2 border-primary"><img src="assets/images/icons/google.png" width="20" alt="" /><span class="ms-3 fw-500">Sign In with Google</span></a>
                        ...
                        <div class="col-12">
                            ...
                            <input name="email" :value="old('email')" required autofocus autocomplete="username" class="form-control" id="email" placeholder="abc@example.com" />
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-check form-switch">
                                <label class="form-check-label d-block" for="remember_me">
