    ...
    <div class="projects-section-line">
        <div class="projects-status">
            <div class="item-status">
                ...
                <span class="status-type">{{$videos->count()}} Videos</span>
            </div>
        </div>
                ...
                <div class="project-box" style="background-color: #d5deff">
                    ...
                    <div class="box-progress-wrapper">
                        ...
                        <div class="box-progress-bar">
                            <span class="box-progress" style="width: 100%; height: 10px; background-color: #afeca6; border: 1px solid #000000"></span>
                        </div>
                        <p class="box-progress-percentage">{{ $displayConfidence }}</p>
                        @elseif ($rawConfidence >= 90)
                        <div class="box-progress-bar">
                            <span class="box-progress" style="height: 10px border: 1px solid width: 90%; background-color: #4067f9"></span>
                        </div>
                        <p class="box-progress-percentage">{{ $displayConfidence }}</p>
                        @else
                        <div class="box-progress-bar">
                            <span class="box-progress" style="height: 10px border: 1px solid width: 80%; background-color: #dd6422"></span>
