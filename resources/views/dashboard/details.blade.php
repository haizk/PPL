        ...
        <div class="detail">
            ...
            <div class="content">
                <div class="right">
                    ...
                    @endphp
                    <div class="detail-progress-bar" style="border: 1px solid #000; ">
                        <span class="detail-progress" style="width: {{ $confidence }}; background-color: #4067f9"></span>
                    </div>
                    <p class="detail-progress-percentage">{{$confidence}}</p>
                    <p>{{ $label }}</p>
                    @endif
                </div>
                <div class="left">
...
<div class="messages-section">
    ...
    <div class="messages">
            ...
            <div class="message-content">
                ...
                <form class="form-body p-3 rounded border bg-light" action="{{ route('dashboard.upload_response') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea style="width: 100%; aspect-ratio: 3/1;" id="response" name="response" class="form-control" rows="3" required></textarea>
                    </div>
                    <div class="d-grid">
        ...
        <div class="message-box">
            ...
            @endphp
            <div style="background-color: {{ $bgColor }}; width: 30px; height: 30px; text-align: center; line-height: 30px; color: #fff; border-radius: 50%;">
